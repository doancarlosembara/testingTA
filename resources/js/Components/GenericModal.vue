...
<template>
    ...
    <a :data-modal-target="modalId" :data-modal-toggle="modalId"
       class="cursor-pointer text-xs font-medium text-blue-600 dark:text-blue-500 hover:underline">
        {{ title }}
    </a>
    <!-- Main modal -->
                    ...
                    <div
                        ...
                        <div v-else>
                            <button :data-modal-hide="modalId" type="button"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-700 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                {{ footerActionName }}
                            </button>
