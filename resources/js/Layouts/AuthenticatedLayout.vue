...
import Logo from "/public/build/assets/logoCVMebel.jpg";
</script>

<template>
    <aside
        id="separator-sidebar"
        class="fixed top-0 z-40 w-64 h-screen transition-transform ltr:-translate-x-full ltr:sm:translate-x-0 rtl:translate-x-full rtl:sm:-translate-x-0"
    ...
    >
        ...
        >
            <ul
                ...
                class="space-y-2 font-medium mb-4"
            >
                <div class="flex flex-row items-center">
                    <div class="bg-blue-500 h-px flex-grow"></div>
                    <img :src="Logo" alt="Logo CV Mebel International" />
                    <div class="bg-blue-500 h-px flex-grow"></div>
                </div>

                <SidebarListItem
                    :item-name="__('My Dashboard')"
                    :hasBadge="false"
                ...
                <SidebarListItem
                    :item-name="__('Organization')"
                    :active-links-recursive="[
                        'branches',
                        'departments',
                        'positions',
                        'shifts',
                ...
                <SidebarListItem
                    ...
                    badge="number"
                    :badge-content="$page.props.ui.reqCount.toString() ?? '?'"
                    link="requests.index"
                    :active-links="[
                        'requests.index',
                        'requests.create',
            ...
            <ul v-else class="space-y-2 font-medium mb-4">
                ...
                <SidebarListItem
                    :item-name="__('My Payrolls')"
                    link="payrolls.index"
                    :active-links="['payrolls.index', 'payrolls.show']"
                >
                    <MoneyIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>

                <SidebarListItem
                    :item-name="__('My Calendar')"
                    link="calendar.index"
                    :active-links="['calendar.index']"
                >
                    <CalendarIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>
                ...
                <nav class="border-b border-gray-300 dark:border-gray-600">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            <div class="flex">
                                <div
                                    class="block my-auto space-x-8 rtl:space-x-reverse sm:-my-px sm:flex"
                                >
                                    <slot name="tabs"></slot>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div class="pt-2 pb-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('employees.index')"
                                >Employees</ResponsiveNavLink
                            >
                            <ResponsiveNavLink :href="route('branches.index')"
                                >Organization</ResponsiveNavLink
                            >
                            <ResponsiveNavLink :href="route('requests.index')"
                                >Requests</ResponsiveNavLink
                            >
                            <ResponsiveNavLink :href="route('calendar.index')"
                                >Calendar</ResponsiveNavLink
                            >
                            <ResponsiveNavLink
                                :href="route('attendances.index')"
                                >Attendance</ResponsiveNavLink
                            >
                            <ResponsiveNavLink :href="route('payrolls.index')"
                                >Payrolls</ResponsiveNavLink
                            >
                        </div>
