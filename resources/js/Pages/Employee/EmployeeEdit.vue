    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Card class="!mt-0">
                    <p class="card-header">
                        {{ __("Edit :name Details", { name: employee.name }) }}
                    </p>
                    <form @submit.prevent="submit" class="form">
                        ...
                        <div class="mt-4">
                            ...
                            <TextInput
                                ...
                                :placeholder="
                                    __(
                                        '114 Joseph Tito, El-Nozha, Cairo, Egypt.'
                                    )
                                "
                            />
                            <InputError
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-4">
                            <div>
                                <InputLabel
                                    for="bank_acc_no"
                                    :value="
                                        __('Bank Account Number (Optional)')
                                    "
                                />
                                <TextInput
                                    id="bank_acc_no"
                                ...
                                <InputError
                                    class="mt-2"
                                    :message="form.errors.bank_acc_no"
                                />
                            </div>
                            <div>
                                <InputLabel
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-4">
                            <div>
                                ...
                                />
                                <p class="text-xs inline ltr:mr-1 rtl:ml-1">
                                    Branch not listed?
                                </p>
                                <form
                                ...
                                >
                                    <GenericModal
                                        :modalId="'branchModal'"
                                        :title="__('Create a new one.')"
                                        :modalHeader="__('Create a New Branch')"
                                        :footerActionName="__('Save')"
                                        :hasCancel="false"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <template #customFooter>
                                            ...
                                            <button
                                                data-modal-hide="departmentModal"
                                                type="button"
                            ...
                            <div>
                                ...
                                >
                                    <GenericModal
                                        modalId="shiftModal"
                                        :title="__('Create a new one.')"
                                        :modalHeader="__('Create a New Shift')"
                                        :footerActionName="__('Save')"
                                        :hasCancel="false"
                                        :has-custom-footer="true"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <TextInput
                                                ...
                                                v-model="
                                                    shiftForm.shift_payment_multiplier
                                                "
                                                autocomplete="off"
                                                :placeholder="
                                                    '1 (' + __('default') + ')'
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-4">
                            <div>
                                <InputLabel
                                    for="is_remote"
                                    :value="__('Remote Worker?')"
                                    class="inline"
                                />
                                <ToolTip>
                                    {{
                                        __(
                                            "Remote Workers can take attendance anywhere, not necessarily from the organization"
                                        )
                                    }}, <br />
                                    {{
                                        __(
                                            "if ip-based attendance is enabled from the organization settings"
                                        )
                                    }}.
                                </ToolTip>
                                <div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <form @submit.prevent="destroy" class="inline">
                                <PrimaryButton
                                    class="bg-red-600 hover:bg-red-700 ml-4"
                                >
                                    {{ __("Delete Employee") }}
                                </PrimaryButton>
                            </form>
