            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Card class="!mt-0">
                    ...
                    <Table
                        ...
                        :showingNumber="employees.data.length"
                        ...
                        <template #Body>
                            ...
                            >
                                ...
                                <TableBody
                                    ...
                                    "
                                    >{{ employee.national_id }}</TableBody
                                >
                                <TableBodyAction
                                    :href="
